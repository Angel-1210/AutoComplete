...
- (void)configureSubviews
{
    ...
    [self.titleLabel enableUserHandleDetectionWithAttributes:@{NSForegroundColorAttributeName:[UIColor blueColor],
                                                                RLHighlightedForegroundColorAttributeName:[UIColor redColor],RLHighlightedBackgroundColorAttributeName:[UIColor clearColor],
    ...
    if ([self.reuseIdentifier isEqualToString:MessengerCellIdentifier]) {
        ...
        //[self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-right-[titleLabel(20)]-left-[titleLabel(>=0@999)]-left-|" options:0 metrics:metrics views:views]];
    }
    else {
...
{
    if (!_titleLabel) {
        _titleLabel = [ResponsiveLabel new];
