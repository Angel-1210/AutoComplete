...
//  AutoComplete
//
//  Created by Dharmesh on 27/08/16.
...
class ViewController : SLKTextViewController, CustomTableViewCellDelegate {
    ...
    func commonInit() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self,  selector: #selector(ViewController.textInputbarDidMove(_:)), name: SLKTextInputbarDidMoveNotification, object: nil)
    ...
    override func viewDidLoad() {
        ...
        self.rightButton.setImage(UIImage(named: "IconSend"), forState: .Normal)
        
        var frame = self.rightButton.frame
        frame.size.width = 80
        self.rightButton.frame = frame
        self.rightButton.contentHorizontalAlignment = .Left
        
        self.textInputbar.autoHideRightButton = true
        self.textInputbar.maxCharCount = 256
        self.textInputbar.counterStyle = .Split
        self.textInputbar.counterPosition = .Top
        self.textInputbar.backgroundColor = UIColor.darkGrayColor()
        //self.textInputbar.contentInset = UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10)
        ...
        self.textView.placeholder = "Write here...";
...
extension ViewController {
    ...
    func messageCellForRowAtIndexPath(indexPath: NSIndexPath) -> MessageTableViewCell {
        ...
        //cell.titleLabel.text = message.text//message.username
        cell.titleLabel .setText(message.text, withTruncation: false)
    ...
    override func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        ...
        if tableView == self.tableView {
            ...
            let titleBounds = (message.text as NSString).boundingRectWithSize(CGSize(width: width, height: CGFloat.max), options: .UsesLineFragmentOrigin, attributes: attributes, context: nil)
...
extension ViewController {
    ...
    func customTableViewCell(cell: MessageTableViewCell!, didTapOnUserHandle userHandle: String!) {
        debugPrint("didTapOnUserHandle")
    }
}
